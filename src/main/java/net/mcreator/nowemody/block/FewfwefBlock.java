...
public class FewfwefBlock extends NowemodyModElements.ModElement {
	@ObjectHolder("nowemody:fewfwef")
	public static final Block block = null;
	public FewfwefBlock(NowemodyModElements instance) {
		super(instance, 82);
	}
