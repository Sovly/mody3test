...
public class KrzesloBlock extends NowemodyModElements.ModElement {
	@ObjectHolder("nowemody:krzeslo")
	public static final Block block = null;
	public KrzesloBlock(NowemodyModElements instance) {
		super(instance, 80);
	}
