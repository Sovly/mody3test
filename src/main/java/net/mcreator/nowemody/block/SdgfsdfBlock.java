...
public class SdgfsdfBlock extends NowemodyModElements.ModElement {
	@ObjectHolder("nowemody:sdgfsdf")
	public static final Block block = null;
	public SdgfsdfBlock(NowemodyModElements instance) {
		super(instance, 81);
	}
