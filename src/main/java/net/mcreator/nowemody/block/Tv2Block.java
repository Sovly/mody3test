...
public class Tv2Block extends NowemodyModElements.ModElement {
	@ObjectHolder("nowemody:tv_2")
	public static final Block block = null;
	public Tv2Block(NowemodyModElements instance) {
		super(instance, 65);
	}
