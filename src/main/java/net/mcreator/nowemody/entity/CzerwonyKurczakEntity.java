...
import net.mcreator.nowemody.entity.renderer.CzerwonyKurczakRenderer;
import net.mcreator.nowemody.NowemodyModElements;

@NowemodyModElements.ModElement.Tag
public class CzerwonyKurczakEntity extends NowemodyModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.4f, 0.7f)).build("czerwony_kurczak").setRegistryName("czerwony_kurczak");
	public CzerwonyKurczakEntity(NowemodyModElements instance) {
		super(instance, 75);
		FMLJavaModLoadingContext.get().getModEventBus().register(new CzerwonyKurczakRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -65485, -1, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("czerwony_kurczak_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 100;
			setNoAI(false);
			setCustomName(new StringTextComponent("Z³y Czerwony Kurczak"));
