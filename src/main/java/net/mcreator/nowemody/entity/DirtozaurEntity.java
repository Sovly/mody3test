...
package net.mcreator.nowemody.entity;
...
import net.mcreator.nowemody.entity.renderer.DirtozaurRenderer;
import net.mcreator.nowemody.NowemodyModElements;

@NowemodyModElements.ModElement.Tag
public class DirtozaurEntity extends NowemodyModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("dirtozaur").setRegistryName("dirtozaur");
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletdirtozaur").setRegistryName("entitybulletdirtozaur");
	public DirtozaurEntity(NowemodyModElements instance) {
		super(instance, 74);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DirtozaurRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("dirtozaur_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity implements IRangedAttackMob {
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (new ItemStack(Blocks.DIRT, (int) (1)).getItem() == stack.getItem())
				return true;
			return false;
		}
	}
