...
public class DiaxyZaFreeGuiWindow extends ContainerScreen<DiaxyZaFreeGui.GuiContainerMod> {
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		nick = new TextFieldWidget(this.font, this.guiLeft + 27, this.guiTop + 10, 120, 20, new StringTextComponent("Wpisz tutaj swój nick")) {
			{
				setSuggestion("Wpisz tutaj swój nick");
			}
			@Override
