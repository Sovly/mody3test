...
package net.mcreator.nowemody.particle;
...
public class CosDziwnegoParticle extends NowemodyModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(true);
	public CosDziwnegoParticle(NowemodyModElements instance) {
		super(instance, 88);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("cos_dziwnego"));
	}
